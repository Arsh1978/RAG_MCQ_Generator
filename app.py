...
<div class="chat-message bot">
    <div class="avatar">
        <img src="https://www.kalupurbank.com/wp-content/uploads/2023/02/robot-chatbot-icon-sign-free-vector.webp" style="max-height: 70px; max-width: 50px; border-radius: 50%; object-fit: cover;">
    </div>
...
<div class="chat-message user">
    <div class="avatar">
        <img src="https://p1.hiclipart.com/preview/359/957/100/face-icon-user-profile-user-account-avatar-icon-design-head-silhouette-neck-png-clipart.jpg" style="max-height: 80px; max-width: 50px; border-radius: 50%; object-fit: cover;">
    </div>    
    <div class="message">{{MSG}}</div>
</div>
'''
...
def get_conversation_chain(vectorstore,target_source_chunks,model_type):
    ...
    match model_type:
        ...
        case "Llama3":
            llm = Ollama(model="llama3", temperature=0.9, top_p=0.9)
        case "HugginFace":
